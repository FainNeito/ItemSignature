...
Project skills in .agents/skills are unchanged copies of upstream codex-skills.
...
The native global-plugin installation and session hooks are not installed. Upstream init/refine git commit steps do not apply until this workspace becomes a git repository.
